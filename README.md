...
<img src="https://capsule-render.vercel.app/api?type=waving&height=220&color=gradient&customColorList=12,20,25&text=SCRIPTING%20WITH%20SAAD&fontSize=45&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=MERN%20Stack%20Developer&descAlignY=55&descSize=20" width="100%"/>
...
```
$ whoami
> Saad — MERN Stack Developer
> Building fast, responsive, no-nonsense web apps.
> Currently: sharpening React + Node in production-grade projects.
```
...
I build web interfaces that don't just work — they feel right. Focused on clean structure, responsive layouts, and interactions that don't get in the user's way.

- 🔨 Stack: **React · Node.js · Express · MongoDB**
- 🎯 Right now: turning design concepts into pixel-accurate, responsive builds
- 🧠 Philosophy: simple code, no bloat, ship it working
- 📍 Based in Pakistan · Available for freelance & collab
...
<img src="https://img.shields.io/badge/-Tailwind_CSS-05122A?style=flat-square&logo=tailwindcss"/>
